...
<body id="kt_body" class="app-blank app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <style>
            body {
                background-image: url('/dashboard/media/auth/bg10.jpeg');
            }

            [data-theme="dark"] body {
                background-image: url('/dashboard/media/auth/bg10-dark.jpeg');
            }
        </style>
        <!--end::Page bg image-->
            ...
            <div class="d-flex flex-lg-row-fluid">
                ...
                <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                    ...
                    <img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                        src="/dashboard/media/auth/agency.png" alt="" />
                    <img class="theme-dark-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                        src="/dashboard/media/auth/agency-dark.png" alt="" />
                    <!--end::Image-->
                    <!--begin::Title-->
                    ...
                    <div class="w-md-400px">
                        ...
                        <form class="form w-100"  method="POST" >
                            ...
                            <div class="text-center mb-11">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder mb-3">{{ __('dashboard.Sign In') }}</h1>
                                <!--end::Title-->
                                <!--begin::Subtitle-->
    ...
    <script src="/dashboard/js/custom/authentication/sign-in/general.js"></script>

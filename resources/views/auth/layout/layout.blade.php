...
<body id="kt_body" class="app-blank app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <style>
            body {
                background-image: url('/Admin/media/auth/bg10.jpeg');
            }

            [data-theme="dark"] body {
                background-image: url('/Admin/media/auth/bg10-dark.jpeg');
            }
        </style>
        <!--end::Page bg image-->
            ...
            <div class="d-flex flex-lg-row-fluid">
                ...
                <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                    ...
                    <img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                        src="/Admin/media/auth/agency.png" alt="" />
                    <img class="theme-dark-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                        src="/Admin/media/auth/agency-dark.png" alt="" />
                    <!--end::Image-->
                    <!--begin::Title-->
                            ...
                            <div class="row g-3 mb-9">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="#"
                                        ...
                                        <img alt="Logo" src="/Admin/media/svg/brand-logos/google-icon.svg"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="#"
                                        class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                                        <img alt="Logo" src="/Admin/media/svg/brand-logos/apple-black.svg"
                                            class="theme-light-show h-15px me-3" />
                                        <img alt="Logo" src="/Admin/media/svg/brand-logos/apple-black-dark.svg"
    ...
    <script src="/Admin/js/custom/authentication/sign-in/general.js"></script>
